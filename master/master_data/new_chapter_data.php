...
$query=$conn->query("SELECT content_tittle from content where content_tittle='$chapter_tittle'");
if($query->num_rows == 1){
?>
<div class="sufee-alert alert with-close alert-danger alert-dismissible fade show">
    <span class="badge badge-pill badge-danger">Error</span>
        Sorry the <strong><?php echo "$chapter_tittle"; ?></strong> is Already Registered.
...
$sql="INSERT INTO content( `content_tittle`, `content_descr`)
                    VALUE('$chapter_tittle','$chapter_descr')";
                    if ($conn->query($sql)==TRUE) {
                        ?>
                        <div class="sufee-alert alert with-close alert-success alert-dismissible fade show">
                            <span class="badge badge-pill badge-success">Done</span>
                                You have Succefully Added New Chapter.
